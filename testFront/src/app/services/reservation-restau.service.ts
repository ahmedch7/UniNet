...
export class ReservationRestaurantService {
  ...
  createReservation(reservation: any): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/restaurant-reservations`, reservation);
  }

  getRestaurantReservations(restaurantId: string): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/restaurant-reservations/${restaurantId}`);
  }

  deleteRestaurantReservation(reservationId: string): Observable<any> {
    return this.http.delete<any>(`${this.apiUrl}/restaurant-reservations/${reservationId}`);
  }
